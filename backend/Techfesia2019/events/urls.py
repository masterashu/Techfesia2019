...
from .views import TagsListCreateView, TagsEditDeleteView, CategoryListCreateView, CategoryEditDeleteView, EventListCreateView

urlpatterns = [
    path('', EventListCreateView.as_view(), name='events_list'),
